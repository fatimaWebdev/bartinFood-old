...
<link rel="stylesheet" href="Bartın komagene pazaryeri-style.css?version=<?= time()?>">
	<!-- header font-->
...
<div class="mySlides fade">
  ...
  <img src="img/bartın-komagene-pazaryeri-2.png" style="width:100%" alt="">
  
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="img/bartın-komagene-pazaryeri-1.png" style="width:100%" alt="" >
  
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="img/bartın-komagene-pazaryeri.png" style="width:100%" alt="">
...
<br>
      ...
      <div class="text-container">
         ...
         <h5>Bartın komagene pazaryeri</h5>
         <div class="icon">
			 <!---- Yer ---> 
			 
			  <button id="myBtn1"><i class="fa fa-location-arrow" aria-hidden="true" ></i> <a href="https://www.google.com/maps/place/Bart%C4%B1n+komagene+pazaryeri/@41.6302518,32.3283849,16z/data=!4m8!1m2!2m1!1sBart%C4%B1n+komagene+pazaryeri!3m4!1s0x409b7308221f68af:0x751b822de20318d7!8m2!3d41.6301432!4d32.335736" target="_blank" style="color: #FFFFFF">Yer</a> </button>  <br>
		<!--- ara ------> 
			 ...
			 <button id="myBtn"><i class="fa fa-cutlery" aria-hidden="true"></i> menu</button>  <br>
				<div id="myModal" class="modal">
				  <div class="modal-content">
					...
					<div class="img-mene">
					<img src="img/WhatsApp Image 2017-07-18 at 22.33.51.jpeg" alt=""  style="width: 100%">
					</div> 
				  </div>
<br>
  ...
  <div id="myDropdown" class="dropdown-content">
    <a href="#home">Pazartesi 11:30-22:00</a>
    <a href="#about">Sali 11:30-22:00</a>
    <a href="#contact">Carcampa 11:30-22:00</a>
     <a href="#contact">Persempe 11:30-22:00</a>
      <a href="#contact">Cuma 11:30-22:00</a>
       <a href="#contact">Cumartisi 11:30-22:00</a>
        <a href="#contact">Pazar 11:30-22:00</a>
  </div>
</div>
