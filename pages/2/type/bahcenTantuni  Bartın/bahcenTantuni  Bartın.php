...
<link rel="stylesheet" href="bahcenTantuni  Bartın-style.css?version=<?= time()?>">
	<!-- header font-->
...
<div class="mySlides fade">
  ...
  <img src="img/bahçen-Tantuni2.png" style="width:100%" alt="">
  
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="img/bahçen-Tantuni-bartin.png" style="width:100%" alt="" >
  
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="img/53229606_784958845204406_7348569540285956096_o.jpg" style="width:100%" alt="">
...
<br>
      ...
      <div class="text-container">
         ...
         <h5>bahçen Tantuni</h5>
         <div class="icon">
			 <!---- Yer ---> 
			 
			  <button id="myBtn1"><i class="fa fa-location-arrow" aria-hidden="true" ></i> <a href="https://www.google.com/maps?q=bah%C3%A7en+Tantuni++Bart%C4%B1n&source=lmns&bih=647&biw=697&safe=strict&hl=en&sa=X&ved=2ahUKEwiqouCVqZHuAhWE34UKHexxCasQ_AUoAXoECAEQAQ" target="_blank" style="color: #FFFFFF">Yer</a> </button>  <br>
		<!--- ara ------> 
			 ...
			 <button id="myBtn"><i class="fa fa-cutlery" aria-hidden="true"></i> menu</button>  <br>
				<div id="myModal" class="modal">
				  <div class="modal-content">
					...
					<div class="img-mene">
					<img src="img/52649437_784958901871067_8972987843068559360_o.jpg" alt="">
					</div> 
				  </div>
<br>
  ...
  <div id="myDropdown" class="dropdown-content">
    <a href="#home">Pazartesi 11:00-22:00</a>
    <a href="#about">Sali 11:00-22:00</a>
    <a href="#contact">Carcampa 11:00-22:00</a>
     <a href="#contact">Persempe 11:00-22:00</a>
      <a href="#contact">Cuma 11:00-22:00</a>
       <a href="#contact">Cumartisi 11:00-20:00</a>
        <a href="#contact">Pazar 11:00-20:00</a>
  </div>
</div>
