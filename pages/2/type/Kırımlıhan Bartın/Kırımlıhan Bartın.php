...
<link rel="stylesheet" href="Kırımlıhan Bartın-style.css?version=<?= time()?>">
	<!-- header font-->
...
<div class="mySlides fade">
  ...
  <img src="img/Kırımlıhan-Bartın2.png" style="width:100%" alt="">
  
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="img/Kırımlıhan-Bartın3.png" style="width:100%" alt="" >
  
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="img/Kırımlıhan-Bartın.png" style="width:100%" alt="">
...
<br>
      ...
      <div class="text-container">
         ...
         <h5>Kırımlıhan Bartın</h5>
         <div class="icon">
			 <!---- Yer ---> 
			 
			  <button id="myBtn1"><i class="fa fa-location-arrow" aria-hidden="true" ></i> <a href="https://www.google.com/maps/place/K%C4%B1r%C4%B1ml%C4%B1+han/@41.630797,32.3368949,20z/data=!4m5!3m4!1s0x409b734fa73d161d:0x1885ab822388dc31!8m2!3d41.6308881!4d32.3371152" target="_blank" style="color: #FFFFFF">Yer</a> </button>  <br>
		<!--- ara --
	<br>
...
<br>
  ...
  <div id="myDropdown" class="dropdown-content">
    <a href="#home">Pazartesi </a>
    <a href="#about">Sali </a>
    <a href="#contact">Carcampa </a>
     <a href="#contact">Persempe </a>
      <a href="#contact">Cuma </a>
