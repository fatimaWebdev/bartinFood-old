...
<link rel="stylesheet" href="Emiroğlu FastFood & Kır Pidesi bartın-style.css?version=<?= time()?>">
	<!-- header font-->
...
<div class="mySlides fade">
  ...
  <img src="img/Emiroğlu-FastFood-&-Kır-Pidesi-bartın1.png" style="width:100%" alt="">
  
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="img/Emiroğlu-FastFood-&-Kır-Pidesi-bartın.png" style="width:100%" alt="" >
  
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="img/Emiroğlu-FastFood-&-Kır-Pidesi-bartın3.png" style="width:100%" alt="">
...
<br>
      ...
      <div class="text-container">
         ...
         <h5>Emiroğlu FastFood & Kır Pidesi </h5>
         <div class="icon">
			 <!---- Yer ---> 
			 
			  <button id="myBtn1"><i class="fa fa-location-arrow" aria-hidden="true" ></i> <a href="https://www.google.com/maps/place/Emiro%C4%9Flu+FastFood+%26+K%C4%B1r+Pidesi/@41.6308385,32.3368613,21z/data=!4m8!1m2!2m1!1sRestaurants!3m4!1s0x0:0x213371473b60689e!8m2!3d41.630873!4d32.336832" target="_blank" style="color: #FFFFFF">Yer</a> </button>  <br>
		<!--- ara ------> 
  ...
  <div id="myDropdown" class="dropdown-content">
    ...
    <a href="#contact">Carcampa 10:00-22:00</a>
     <a href="#contact">Persempe 10:00-22:00</a>
      <a href="#contact">Cuma10:00-22:00 </a>
       <a href="#contact">Cumartisi 10:00-20:00</a>
        <a href="#contact">Pazar 10:00-20:00</a>
  </div>
</div>
