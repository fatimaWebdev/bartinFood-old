...
<link rel="stylesheet" href="Kahve Aşkına Bartın-style.css?version=<?= time()?>"s>
	<!-- header font-->
...
<div class="mySlides fade">
  ...
  <img src="img/Kahve-Aşkına-Bartın-.png" style="width:100%" alt="">
      ...
      <div class="text-container">
         ...
         <div class="icon">
			 <!---- Yer ---> 
			  ...
			  <button id="myBtn1"><i class="fa fa-location-arrow" aria-hidden="true" ></i> <a href="https://www.google.com/maps/place/Kahve+A%C5%9Fk%C4%B1na+Bart%C4%B1n/@41.6373697,32.3363989,17z/data=!4m5!3m4!1s0x409b73c17651807d:0x7acdeaccabbb45e5!8m2!3d41.6383089!4d32.3359448" target="_blank" style="color: #FFFFFF">Yer</a> </button>  <br>
		<!--- ara ---
	<br>
