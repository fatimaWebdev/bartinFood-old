...
<link rel="stylesheet" href="Dalyan Balik Evi Bartın-style.css?version=<?= time()?>">
	<!-- header font-->
...
<div class="mySlides fade">
  ...
  <img src="img/Dalyan-Balik-Evi-Bartın.png" style="width:100%" alt="">
...
<div class="mySlides fade">
  ...
  <img src="img/Dalyan-Balik-Evi-Bartın1.png" style="width:100%" alt="">
...
<br>
      ...
      <div class="text-container">
         ...
         <h5>Dalyan Balik Evi</h5>
         <div class="icon">
			 <!---- Yer ---> 
			 
			  <button id="myBtn1"><i class="fa fa-location-arrow" aria-hidden="true" ></i> <a href="https://www.google.com/maps/place/Dalyan+Bal%C4%B1k+evi/@41.627885,32.3259532,17z/data=!4m8!1m2!2m1!1sDalyan+Balik+Evi!3m4!1s0x0:0x77881345e0ccc163!8m2!3d41.627881!4d32.3281419" target="_blank" style="color: #FFFFFF">Yer</a> </button>  <br>
		<!--- ara ------> 
     ...
     <a href="#contact">Persempe 10:00-22:00</a>
      <a href="#contact">Cuma 10:00-22:00</a>
       <a href="#contact">Cumartisi X</a>
        <a href="#contact">Pazar 10:00-22:00</a>
  </div>
</div>
