...
<link rel="stylesheet" href="food-style.css?version=<?= time()?>">
	<!-- header font-->
...
<div class="mySlides fade">
  ...
  <img src="img/Untitled-3.png" style="width:100%" alt="">
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="img/Untitled-1.png" style="width:100%" alt="" >
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="img/Untitled-2.png" style="width:100%" alt="">
</div>
...
<br>
      ...
      <div class="text-container">
         ...
         <h5>Naddet Döner Burger</h5>
         <div class="icon">
			 <!---- Yer ---> 
			 
			  <button id="myBtn1"><i class="fa fa-location-arrow" aria-hidden="true" ></i> <a href="Kemer Köprü, Şadırvan Cd. No:5, 74100 Bartın Merkez/Bartın" target="_blank" style="color: #FFFFFF">Yer</a> </button>  <br>
		<!--- ara ------> 
			 ...
			 <button id="myBtn"><i class="fa fa-cutlery" aria-hidden="true"></i> menu</button>  <br>
				<div id="myModal" class="modal">
				  <div class="modal-content">
					...
					<div class="img-mene">
					<img src="img/Untitled-2.png"  alt=""  style="width: 100%">
					</div> 
				  </div>
<br>
			 </div>
  ...
  <div id="myDropdown" class="dropdown-content">
    <a href="#home">Pazartesi <br> 11–00</a>
    <a href="#about">Sali <br> 11-00</a>
    <a href="#contact">Carcampa <br> 11-00</a>
     <a href="#contact">Persempe <br> 11-00</a>
      <a href="#contact">Cuma <br> 11-00</a>
       <a href="#contact">Cumartisi <br> 11-20</a>
        <a href="#contact">Pazar <br> 11-20</a>
  </div>
</div>
