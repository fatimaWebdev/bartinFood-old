...
<link rel="stylesheet" href="Burger King-style.css?version=<?= time()?>">
	<!-- header font-->
...
<div class="mySlides fade">
  ...
  <img src="img/Burger-King-bartin1.png" style="width:100%" alt="">
  <div class="text">Caption Text</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="img/Burger-King-bartin0.png" style="width:100%" alt="" >
  <div class="text">Caption Two</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="img/Burger-King-bartin.png"  style="width:100%" alt="">
      ...
      <div class="text-container">
         ...
         <div class="icon">
			 <!---- Yer ---> 
			  ...
			  <button id="myBtn1"><i class="fa fa-location-arrow" aria-hidden="true" ></i> <a href="https://www.google.com/maps/place/Burger+King/@41.6333315,32.3377006,18z/data=!4m8!1m2!2m1!1sRestaurants!3m4!1s0x0:0x490d418a3f2b8bdc!8m2!3d41.6332858!4d32.3383353?hl=en" target="_blank" style="color: #FFFFFF">Yer</a> </button>  <br>
		<!--- ara ------> 
...
<br>
  ...
  <div id="myDropdown" class="dropdown-content">
    <a href="#home">Pazartesi 10:30AM–10:30PM</a>
    <a href="#about">Sali 10:30AM–10:30PM</a>
    <a href="#contact">Carcampa 10:30AM–10:30PM</a>
     <a href="#contact">Persempe 10:30AM–10:30PM</a>
      <a href="#contact">Cuma10:30AM–10:30PM</a>
       <a href="#contact">Cumartisi 10:30AM–20:00PM</a>
        <a href="#contact">Pazar 10:30AM–20:00PM</a>
  </div>
</div>
