...
<link rel="stylesheet" href="Domino's Pizza Bartin-style.css?version=<?= time()?>">
	<!-- header font-->
...
<div class="mySlides fade">
  ...
  <img src="img/Domino's-Pizza-Bartin.png" style="width:100%" alt="">
  <div class="text">Caption Text</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="img/Domino's-Pizza-Bartin00.png" style="width:100%" alt="" >
  <div class="text">Caption Two</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="img/Domino's-Pizza-Bartin-0.png" style="width:100%" alt="">
      ...
      <div class="text-container">
         ...
         <div class="icon">
			 <!---- Yer ---> 
			  ...
			  <button id="myBtn1"><i class="fa fa-location-arrow" aria-hidden="true" ></i> <a href="https://www.google.com/maps/place/Domino's+Pizza+Bartin/@41.633291,32.338136,21z/data=!4m8!1m2!2m1!1sRestaurants!3m4!1s0x409b7233bdca3297:0x775bf758859141ff!8m2!3d41.6332607!4d32.3382146" target="_blank" style="color: #FFFFFF">Yer</a> </button>  <br>
		<!--- ara ------> 
			 ...
			 <button id="myBtn"><i class="fa fa-cutlery" aria-hidden="true"></i> menu</button>  <br>
				<div id="myModal" class="modal">
				  <div class="modal-content">
					...
					<div class="img-mene">
					<img src="img/Domino's-Pizza-Bartin-menu.jpg" alt=""  style="width: 100%">
					</div> 
				  </div>
<br>
  ...
  <div id="myDropdown" class="dropdown-content">
    <a href="#home">Pazartesi 11:30AM–10:00PM</a>
    <a href="#about">Sali 11:30AM–10:00PM</a>
    <a href="#contact">Carcampa 11:30–10:00PM</a>
     <a href="#contact">Persempe 11:30–10:00PM</a>
      <a href="#contact">Cuma 11:30–10:00PM</a>
       <a href="#contact">Cumartisi 11:30–08:00PM</a>
        <a href="#contact">Pazar 11:30–08:00PM</a>
  </div>
</div>
