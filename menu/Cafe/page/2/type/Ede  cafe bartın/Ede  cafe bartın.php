...
<link rel="stylesheet" href="Ede  cafe bartın-style.css"?version=<?= time()?>>
	<!-- header font-->
...
<div class="mySlides fade">
  ...
  <img src="Ede--cafe-bartın1.png" style="width:100%" alt="">
</div>
<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="Ede--cafe-bartın3.png" style="width:100%" alt="">
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="Ede--cafe-bartın4.png" style="width:100%" alt="" >
</div>
      ...
      <div class="text-container">
         ...
         <div class="icon">
			 <!---- Yer ---> 
			  ...
			  <button id="myBtn1"><i class="fa fa-location-arrow" aria-hidden="true" ></i> <a href="https://www.google.com/maps?safe=strict&sxsrf=ALeKk03u5F7iBeW5bFRHW6GuRoyJnMv0yg:1611047908962&q=Ede++cafe+bart%C4%B1n&gs_lcp=CgZwc3ktYWIQAzIQCC4QxwEQrwEQyQMQExCTAjIICAAQFhAeEBNQpeYDWKXmA2Dc7gNoAHAAeACAAeoBiAHqAZIBAzItMZgBAKABAqABAaoBB2d3cy13aXo&uact=5&um=1&ie=UTF-8&sa=X&ved=2ahUKEwjAsYax1afuAhUPCRoKHTDnCx4Q_AUoAnoECAYQBA" target="_blank" style="color: #FFFFFF">Yer</a> </button>  <br>
		<!--- ara ------> 
