...
<link rel="stylesheet" href="BOSSO CAFE bartın-style.css?version=<?= time()?>">
	<!-- header font-->
...
<div class="mySlides fade">
  ...
  <img src="img/BOSSO-CAFE-bartın1.png" style="width:100%" alt="">
  
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="img/BOSSO-CAFE-bartın-.png" style="width:100%" alt="" >
      ...
      <div class="text-container">
         ...
         <div class="icon">
			 <!---- Yer ---> 
			  ...
			  <button id="myBtn1"><i class="fa fa-location-arrow" aria-hidden="true" ></i> <a href="https://www.google.com/maps/place/BOSSO+COFFEE/@41.6309643,32.3373858,21z/data=!4m5!3m4!1s0x409b73a672e7f86f:0xaf34681460ca3886!8m2!3d41.6309643!4d32.3375226" target="_blank" style="color: #FFFFFF">Yer</a> </button>  <br>
		<!--- ara ------> 
...
function closeNav() {
  document.getElementById("mySidenav").style.width = "0";
			 ...
			 <!--- menu ----> 
			  ...
			  <button id="myBtn1"><i class="fa fa-cutlery" aria-hidden="true" ></i> <a href="https://www.bossocoffee.com/menu/" target="_blank" style="color: #FFFFFF">menu</a> </button>  <br>
