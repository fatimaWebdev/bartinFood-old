...
<link rel="stylesheet" href="../Peron Bistro bartın/Peron Bistro bartın-style.css
?version=<?= time()?>
">
	<!-- header font-->
...
<div class="mySlides fade">
  ...
  <img src="Southill-cafe-bartın2.png" style="width:100%" alt="">
  
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="Southill-cafe-bartın.png" style="width:100%" alt="" >
 </div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="Southill-cafe-bartın1.png" style="width:100%" alt="">
      ...
      <div class="text-container">
         ...
         <div class="icon">
			 <!---- Yer ---> 
			  ...
			  <button id="myBtn1"><i class="fa fa-location-arrow" aria-hidden="true" ></i> <a href="https://www.google.com/maps/place/Southill+Cafe+%26+Restaurant+Bart%C4%B1n/@41.6259129,32.3217035,17z/data=!3m1!4b1!4m5!3m4!1s0x409b722ab61e9e11:0x5a128e68a977fe08!8m2!3d41.6259129!4d32.3217035" target="_blank" style="color: #FFFFFF">Yer</a> </button>  <br>
		<!--- ara ------> 
...
function closeNav() {
  document.getElementById("mySidenav").style.width = "0";
			 ...
			 <button id="myBtn1"><i class="fa fa-cutlery" aria-hidden="true" ></i> <a href="http://www.southillcafe.com/" target="_blank" style="color: #FFFFFF">menu</a> </button>  <br>
  ...
  <div id="myDropdown" class="dropdown-content">
    <a href="#home">Pazartesi 10:00AM–10:00PM</a>
    <a href="#about">Sali 10:00AM–10:00PM</a>
    <a href="#contact">Carcampa 10:00AM–10:00PM</a>
     <a href="#contact">Persempe 10:00AM–10:00PM</a>
      <a href="#contact">Cuma 10:00AM–10:00PM</a>
