...
<link rel="stylesheet" href="pazzo cafe barin-style.css?version=<?= time()?>">
	<!-- header font-->
...
<div class="mySlides fade">
  ...
  <img src="img/pazzo-cafe-bartin0-.png" style="width:100%" alt="">
</div>
      ...
      <div class="text-container">
         ...
         <div class="icon">
			 <!---- Yer ---> 
			  ...
			  <button id="myBtn1"><i class="fa fa-location-arrow" aria-hidden="true" ></i> <a href="https://www.google.com/maps/place/pazzo+chef+cafe+restaurant/@41.6320563,32.3367582,18z/data=!4m8!1m2!2m1!1sRestaurants!3m4!1s0x0:0xa6816beb879f7f3b!8m2!3d41.6320734!4d32.3368835" target="_blank" style="color: #FFFFFF">Yer</a> </button>  <br>
		<!--- ara ------> 
...
<br>
  ...
  <div id="myDropdown" class="dropdown-content">
    <a href="#home">Pazartesi 10AM–08PM</a>
    <a href="#about">Sali 10AM–08PM</a>
    <a href="#contact">Carcampa 10AM–08PM</a>
     <a href="#contact">Persempe 10AM–08PM</a>
      <a href="#contact">Cuma 10AM–08PM</a>
       <a href="#contact">X</a>
        <a href="#contact">X</a>
  </div>
</div>
