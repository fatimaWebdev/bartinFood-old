...
<div class="f">
 ...
 <div class="column" style="100%">
    <div class="card1" style="width: 100%;">
	<a href="type/burger evi bartın/burger evi bartın.php">
  <img src="type/burger evi bartın/burger-evi-bartın2.png" alt="" width="100%" >
  <div class="container">
    <h2>Burger<br>Evi</h2> 
    <p>Burger</p>
 <span class="heading">review</span>
...
<button class="btn"> Daha</button>
  ...
  <img src="type/Naddet Döner Burger/img/img2/neddet-döner-bartın.png" alt="" width="100%" >
  <div class="container">
    <h2>Naddet<br>Burger</h2> 
    <p>Döner & Burger</p>
 <span class="heading">review</span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
...
<button class="btn"> Daha</button>
	...
	<div class="column">
    <div class="card1" style="width: 100%;">
		<a href="type/MAŞHA BURGER/MAŞHA BURGER.php">
  <img src="type/MAŞHA BURGER/MAŞHA--BURGER.png" alt="" width="100%" >
  <div class="container">
    <h2>MAŞHA <br>BURGER</h2> 
    <p>ET& BURGER</p>
 <span class="heading">review</span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
