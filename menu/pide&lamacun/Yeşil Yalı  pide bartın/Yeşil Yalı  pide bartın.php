...
<head>
<meta charset="utf-8">
<title>Bartitn Food</title>
<link rel="stylesheet" href="Yeşil Yalı  pide bartın.css?version=<?= time()?>">
	<!-- header font-->
...
<div class="mySlides fade">
  ...
  <img src="Yeşil-Yalı--pide-bartın2.png" style="width:100%" alt="">
 
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="Yeşil-Yalı--pide-bartın3.png" style="width:100%" alt="" >
 
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="Yeşil-Yalı--pide-bartın4.png" style="width:100%" alt="">
...
<br>
      ...
      <div class="text-container">
         ...
         <h5>Yeşil Yalı  pide  </h5>
         <div class="icon">
			 <!---- Yer ---> 
			 
			  <button id="myBtn1"><i class="fa fa-location-arrow" aria-hidden="true" ></i> <a href="https://www.google.com/maps/place/Ye%C5%9Fil+Yal%C4%B1+Et+Mangal,+Pide,+Kebap,+Lahmacun,+Yemek+ve+Restaurant+Bart%C4%B1n/@41.6381922,32.3178862,14z/data=!3m1!4b1!4m5!3m4!1s0x409b73cac3d33e9b:0x38e729e8ecce46f5!8m2!3d41.6381935!4d32.3353529?hl=en" target="_blank" style="color: #FFFFFF">Yer</a> </button>  <br>
		<!--- ara ------> 
...
function closeNav() {
  document.getElementById("mySidenav").style.width = "0";
			 ...
			 <!--- menu ---->
			  <br>
			 <button id="myBtn1"><i class="fa fa-cutlery" aria-hidden="true" ></i> <a href="https://www.yesilyalibartin.com/" target="_blank" style="color: #FFFFFF">Website</a> </button>  <br>
