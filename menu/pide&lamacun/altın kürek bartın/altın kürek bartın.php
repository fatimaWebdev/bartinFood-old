...
<link rel="stylesheet" href="altın kürek bartın.css?
?version=<?= time()?>
">
	<!-- header font-->
...
<div class="mySlides fade">
  ...
  <img src="altın-kürek-bartın2.png" style="width:100%" alt="">
 
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="altın-kürek-bartın4.png" style="width:100%" alt="" >
 
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="altın-kürek-bartın5.png" style="width:100%" alt="">
      ...
      <div class="text-container">
         ...
         <div class="icon">
			 <!---- Yer ---> 
			  ...
			  <button id="myBtn1"><i class="fa fa-location-arrow" aria-hidden="true" ></i> <a href="https://www.google.com/maps/place/Alt%C4%B1n+K%C3%BCrek+Pide+ve+Lahmacun+Salonu+Bart%C4%B1n/@41.6326617,32.3391357,17z/data=!3m1!4b1!4m5!3m4!1s0x409b73119fd3d641:0xdb91c333629279b!8m2!3d41.6326617!4d32.3413244 " style="color: #FFFFFF">Yer</a> </button>  <br>
		<!--- ara ------> 
			 ...
			 <button id="myBtn"><i class="fa fa-cutlery" aria-hidden="true"></i> menu</button>  <br>
				<div id="myModal" class="modal">
				  <div class="modal-content">
					...
					<div class="img-mene">
					<img src="altın-kürek-bartın-menu.png" alt=""  style="width: 100%">
					</div> 
				  </div>
<br>
