...
<link rel="stylesheet" href="Lahmacun Sefası.css?version=<?= time()?>">
	<!-- header font-->
...
<div class="mySlides fade">
  ...
  <img src="lahmacun-sefası-bartın.png" style="width:100%" alt="">
 
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="lahmacun-sefası-bartın3.png" style="width:100%" alt="" >
 
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="lahmacun-sefası-bartın2.png" style="width:100%" alt="">
      ...
      <div class="text-container">
         ...
         <div class="icon">
			 <!---- Yer ---> 
			  ...
			  <button id="myBtn1"><i class="fa fa-location-arrow" aria-hidden="true" ></i> <a href="https://www.google.com/maps/place/Lahmacun+Sefas%C4%B1/@41.6321908,32.3334154,17z/data=!4m5!3m4!1s0x409b73630cb61d2d:0x7bcd1dc42472907a!8m2!3d41.6321908!4d32.3356041?hl=en" target="_blank" style="color: #FFFFFF">Yer</a> </button>  <br>
		<!--- ara ------> 
			 ...
			 <button id="myBtn"><i class="fa fa-cutlery" aria-hidden="true"></i> menu</button>  <br>
				<div id="myModal" class="modal">
				  <div class="modal-content">
					...
					<div class="img-mene">
					<img src="yaz_3.jpg" alt=""  style="width: 100%">
					</div> 
				  </div>
<br>
