...
<link rel="stylesheet" href="Çappa-Balık-Restaurant-bartin.css?version=<?= time()?>">
	<!-- header font-->
...
<div class="mySlides fade">
  ...
  <img src="Çappa-Balık-Restaurant-bartin2.png" style="width:100%" alt="">
 
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="Çappa-Balık-Restaurant-bartin3.png" style="width:100%" alt="" >
 
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="Çappa-Balık-Restaurant-bartin4.png" style="width:100%" alt="">
...
<br>
      ...
      <div class="text-container">
         ...
         <h5> Çappa Balık Restaurant
</h5>
         <div class="icon">
			 <!---- Yer ---> 
			 
			  <button id="myBtn1"><i class="fa fa-location-arrow" aria-hidden="true" ></i> <a href="https://www.google.com/maps/place/%C3%87appa+Bal%C4%B1k+Restaurant/@41.6366755,32.3169928,14z/data=!4m8!1m2!2m1!1zw4dhcHBhLUJhbMSxay1SZXN0YXVyYW50LSBiYXJ0xLFu!3m4!1s0x409b73cb346190bd:0x1ff943b019eda6f1!8m2!3d41.6366755!4d32.3345023?hl=en" style="color: #FFFFFF">Yer</a> </button>  <br>
		<!--- ara ------> 
