...
<div class="f">
	<div class="row">
	  ...
	  <img src="../../type/Resume Çiğköfte bartin/img/Resume-Çiğköfte-bartin.png" alt="" width="100%" >
	  <div class="container">
 ...
 <div class="column" style="100%">
    <div class="card1" style="width: 100%;">
	<a href="ÜNLÜ çiğköfte bartın/ÜNLÜ-çiğköfte-bartın.php">
  <img src="ÜNLÜ çiğköfte bartın/ÜNLÜ-çiğköfte-bartın.png" alt="" width="100%" >
  <div class="container">
    <h2>ÜNLÜ<br>Çiğköfte</h2> 
    <p>Çiğköfte</p>
 <span class="heading">review</span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
...
<button class="btn"> Daha</button>
  ...
  ------->
	...
	<div class="column" style="100%">
    <div class="card1" style="width: 100%;">
	<a href="Ahmet çiğköfte bartın/Ahmet çiğköfte bartın.php">
  <img src="Ahmet çiğköfte bartın/Ahmet-çiğköfte-bartın.png" alt="" width="100%" >
  <div class="container">
...
<button class="btn"> Daha</button>
	...
	<div class="column" style="100%">
    <div class="card1" style="width: 100%;">
	<a href="../../pages/2/type/Bartın komagene pazaryeri/Bartın komagene pazaryeri.php">
  <img src="Bartın komagene pazaryeri/img/Bartın-komagene-pazaryeri.png" alt="" width="100%" >
  <div class="container">
    <h2>Komagene<br>Çiğköfte</h2> 
    <p>Çiğköfte</p>
 <span class="heading">review</span>
...
<button class="btn"> Daha</button>
	...
	<div class="column" style="100%">
    <div class="card1" style="width: 100%;">
	<a href="Hacıalioğlu/Hacıalioğlu-çiğköfte-bartın.php">
  <img src="Hacıalioğlu/Hacıalioğlu-çiğköfte-bartın2.png" alt="" width="100%" >
  <div class="container">
    <h2>Hacıalioğlu<br>Çiğköfte</h2> 
    <p>Çiğköfte</p>
 <span class="heading">review</span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
...
<button class="btn"> Daha</button>
	...
	<div class="column" style="100%">
    <div class="card1" style="width: 100%;">
	<a href="pan çiğköfte bartın/pan çiğköfte bartın.php">
  <img src="pan çiğköfte bartın/pan-çiğköfte-bartın.png" alt="" width="100%" >
  <div class="container">
    <h2>pan <br>Çiğköfte</h2> 
    <p>Çiğköfte</p>
 <span class="heading">review</span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
