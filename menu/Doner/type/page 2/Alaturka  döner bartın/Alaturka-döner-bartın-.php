...
<link rel="stylesheet" href="Alaturka-döner-bartın-2-style.css?version=<?= time()?>"
	<!-- header font-->
...
<div class="mySlides fade">
  ...
  <img src="Alaturka--döner-bartın.png" style="width:100%" alt="">
 
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="Alaturka--döner-bartın-2.png" style="width:100%" alt="" >
 
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="S-katık-Döner-bartın4.png" style="width:100%" alt="">
</div>
...
<br>
      ...
      <div class="text-container">
         ...
         <h5>Alaturka döner </h5>
         <div class="icon">
			 <!---- Yer ---> 
			 
			  <button id="myBtn1"><i class="fa fa-location-arrow" aria-hidden="true" ></i> <a href="https://www.google.com/maps/place/Alaturka+D%C3%B6ner/@41.6289467,32.3372055,17z/data=!3m1!4b1!4m5!3m4!1s0x409b722e32b43b2b:0x90cfaffb8fd192d6!8m2!3d41.6289467!4d32.3372055"  target="_blank" style="color: #FFFFFF">Yer</a> </button>  <br>
		<!--- ara ------> 
