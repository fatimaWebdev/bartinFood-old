...
<link rel="stylesheet" href="../Kardelen Döner bartın/Kardelen Döner bartın-style.css?version=<?= time()?>">
	<!----- header font------->
...
<div class="mySlides fade">
  ...
  <img src="Tadim-Hatay-Dürüm-bartın3.png" style="width:100%" alt="">
 
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="Tadim-Hatay-Dürüm-bartın2.png" style="width:100%" alt="" >
 
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="Tadim-Hatay-Dürüm-bartın4.png" style="width:100%" alt="">
</div>
...
<br>
      ...
      <div class="text-container">
         ...
         <h5>Tadim Hatay Dürüm </h5>
         <div class="icon">
			 <!---- Yer ---> 
			 
			  <button id="myBtn1"><i class="fa fa-location-arrow" aria-hidden="true" ></i> <a href="https://www.google.com/maps/place/Tadim+Hatay+D%C3%BCr%C3%BCm/@41.6342533,32.3346381,17z/data=!3m1!4b1!4m5!3m4!1s0x409b723388a65537:0x421695a581c6a0b0!8m2!3d41.6342533!4d32.3368268"  target="_blank" style="color: #FFFFFF">Yer</a> </button>  <br>
		<!--- ara ------> 
